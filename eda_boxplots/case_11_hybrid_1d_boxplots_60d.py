"""EDA workflow combining technical features with 1-day target statistics using 60-day windows."""
...
def run_case(
    *,
    ...
    """Run case 11 combining technical features with 1-day target statistics using 60-day windows."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the 1-day hybrid feature boxplot workflow.",
    )
    parser.add_argument(
        "--dataset",
